...
extension KeyboardShortcuts.Name {
    ...
    static let openADOComment   = Self("openADOComment",   default: .init(.a, modifiers: [.command, .shift]))
    static let openSubtaskInput = Self("openSubtaskInput", default: .init(.t, modifiers: [.command, .shift]))
    static let openHistory      = Self("openHistory",      default: .init(.h, modifiers: [.command, .shift]))
    static let showMainWindow   = Self("showMainWindow",   default: .init(.m, modifiers: [.command, .shift]))
